...
class Messages {
  ...
  constructor() {
    ...
    // Observe tab change
    obs(document.querySelector(ogameVersion.isAtLeast_13_0_0 ? "#messagescomponent" :"#messagecontainercomponent"), (elements) => {
    ...
    if (document.querySelector(ogameVersion.isAtLeast_13_0_0 ? "#messagescomponent #messages" : "#messagecontainercomponent #messagewrapper")) {
      this.#parseMessages();
    }
  }
  ...
  #currentTab() {
    const currentTab = document.querySelector(
      ogameVersion.isAtLeast_13_0_0 ? "#messagescomponent #messages .tabsWrapper .innerTabItem.active"
  ...
  #tabControls(tabElement) {
    const element = document.querySelector(ogameVersion.isAtLeast_13_0_0 ? "#messages .messagesHolder" : "#messagewrapper .messagesHolder");
  ...
  #currentSubTab() {
    ...
    // If no sub tabs
    if (document.querySelectorAll(ogameVersion.isAtLeast_13_0_0 ? "#messages .tabsWrapper > .innerTabItem" : "#messagewrapper .tabsWrapper > .innerTabItem")?.length <= 1) return elementControls;

    const current_sub_tab = elementControls.querySelector(ogameVersion.isAtLeast_13_0_0 ? "#messages .tabsWrapper > .innerTabItem.active" : "#messagewrapper .tabsWrapper > .innerTabItem.active");
