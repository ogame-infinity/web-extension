...
import FlightMessagesAnalyzer from "../../ctxcontent/services/analyzer/FightMessagesAnalyzer.js";
...
class Messages {
  ...
  constructor() {
    ...
    this.#analyzers = [new SpyMessagesAnalyzer(), new ExpeditionMessagesAnalyzer(), new FlightMessagesAnalyzer()];
