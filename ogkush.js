...
class OGInfinity {
  ...
  keyboardActions() {
    ...
    if (this.page == "fleetdispatch") {
      document.addEventListener("keydown", (event) => {
        if (fleetDispatcher.currentPage == "fleet1" && document.activeElement.tagName != "INPUT") {
          if (event.code == "KeyE") {
      ...
      tech: {
        1: {
          ...
          111: {
            ...
            tr: "İntergalaktik Araştırma Ağı",
            },
            124: {
            de: "Astrophysik",
            en: "Astrophysics",
