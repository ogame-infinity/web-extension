  ...
  minesLevel() {
    ...
    if (this.page == "supplies" && !this.current.isMoon) {
      let targetMetal = document.querySelector(
        ".technology.metalMine .twargetlevel"
      );
      let targetCrystal = document.querySelector(
        ".technology.crystalMine .targetlevel"
      );
